...
tar_init_run "tar_1.5B_finetune_viscot"
N_GPUS=${N_GPUS:-${SLURM_GPUS_ON_NODE:-4}}
PREV_STAGE_CHECKPOINT="${PREV_STAGE_CHECKPOINT:-$MODELS_ROOT/Tar-1.5B}"
DATA_PATH="${DATA_PATH:-$DATA_ROOT/v_cot_reason/Visual-CoT/vila-u_format_viscot_363k.json}"
MAX_STEPS=${MAX_STEPS:-60000}
LR=${LR:-1e-5}
TRAIN_PARTS="${TRAIN_PARTS:-mm_language_model}"
IMAGE_FOLDER="${IMAGE_FOLDER:-$DATA_ROOT/v_cot_reason/Visual-CoT/images_vila-u}"
tar_require_paths "$IMAGE_FOLDER"
